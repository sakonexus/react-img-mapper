...
var ImageMapper = function (props) {
    ...
    var renderAreas = function () {
        var all_areas = props.map.areas;
        var all_areas_scaled = [];
        ...
        return map.areas.map(function (area, index) {
            ...
            all_areas_scaled.push(extendedArea);

            if (area.disabled)
                return null;
            return (
                react_1.default.createElement(
                    "area", { key: area[areaKeyName] || index.toString(), 
                        shape: area.shape, coords: scaledCoords.join(','), 
                        onMouseEnter: function (event) {
                            return hoverOn(extendedArea, index, event, all_areas_scaled, multiRegion); 
                        }, 
