...
export declare type TouchEvent = React.TouchEvent<HTMLAreaElement>;
export declare type AreaEvent = React.MouseEvent<HTMLAreaElement, MouseEvent>;
export declare type ImageEvent = React.MouseEvent<HTMLImageElement, MouseEvent>;
